...
defaults = struct('data_dir', 'd:/meg_laminar/derivatives/spm12', 'inv_type', 'EBB',...
    'patch_size',0.4, 'surf_dir', 'd:/meg_laminar/derivatives/freesurfer', 'iterations',10,... %'step_size',100,...
    'thresh_percentile',80,'roi_type','mean', 'whole_brain', false);  %define default values
