function plot_classification_results_subjects_shuffled(subjects, contrast, varargin)
...
for subj_idx=1:length(subjects)
    ...
    white_inflated=fullfile(params.surf_dir,subj_info.subj_id,'ds_white.hires.deformed_inflated.surf.gii');
    ...
    pial_inflated=fullfile(params.surf_dir,subj_info.subj_id,'ds_pial.hires.deformed_inflated.surf.gii');
