function export_classification_results_subjects(subjects, contrast, varargin)
...
fid=fopen(fullfile(params.data_dir,contrast.comparison_name,'subjects_data.csv'),'w');
