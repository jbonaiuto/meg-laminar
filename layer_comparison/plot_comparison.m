...
white_inflated_mesh=gifti(fullfile(params.surf_dir,subj_info.subj_id,'surf','ds_white.hires.deformed_inflated.surf.gii'));
...
pial_inflated_mesh=gifti(fullfile(params.surf_dir,subj_info.subj_id,'surf','ds_pial.hires.deformed_inflated.surf.gii'));
