...
defaults = struct('data_dir', 'd:/pred_coding/derivatives/spm12', 'inv_type', 'EBB',...
    'patch_size',0.4, 'surf_dir', 'd:/pred_coding/derivatives/freesurfer', 'iterations',10,... %'step_size',100,...
...
for i=1:length(contrasts)
    ...
    for subj_idx=1:length(subjects)
        ...
        white_inflated_mesh=fullfile(params.surf_dir,subj_info.subj_id,'ds_white.hires.deformed_inflated.surf.gii');
        ...
        pial_inflated_mesh=fullfile(params.surf_dir,subj_info.subj_id,'ds_pial.hires.deformed_inflated.surf.gii');
        ...
        foi_dir=fullfile(params.data_dir, subj_info.subj_id,...
            sprintf('ses-0%d',good_sessions(1)), 'grey_coreg', params.inv_type,...
