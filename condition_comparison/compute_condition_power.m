...
grey_coreg_dir=fullfile(params.data_dir,'derivatives', subj_info.subj_id,...
...
if (exist(pial_data_filename,'file')==2 && exist(wm_data_filename,'file')==2) && ~params.recompute
    ...
    surf_dir=fullfile(params.data_dir,'derivatives','freesurfer',subj_info.subj_id);
    ...
    foi_dir=fullfile(params.data_dir, 'derivatives/spm12', subj_info.subj_id,...
    ...
    grey_coreg_dir=fullfile(params.data_dir,'derivatives/spm12',...
        subj_info.subj_id, sprintf('ses-%02d', session_num), 'grey_coreg');
    foi_dir=fullfile(grey_coreg_dir, params.inv_type,...
        ['p' num2str(params.patch_size)], contrast.zero_event,...
        ['f' num2str(contrast.foi(1)) '_' num2str(contrast.foi(2))]);
