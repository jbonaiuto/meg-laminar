...
for session_num=1:length(subj_info.sessions)
    ...
    for run_idx=1:subj_info.sessions(session_num)
        load(fullfile('C:/pred_coding/scanning', subj_info.subj_id, num2str(session_num), sprintf('data_%d.mat', run_idx)));
        load(fullfile('C:/pred_coding/scanning', subj_info.subj_id, num2str(session_num), sprintf('stim_%d.mat', run_idx)));
