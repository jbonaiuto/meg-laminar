function [cond_erps trial_times]=subject_erp(subj_info, zero_event, woi, erp_type, varargin)
...
subject_tpl = set(subject_tpl, 'var', {'PAGETITLE','ZEROEVENT','WOI'}, ...
    {['ERP: Subject ' subj_info.subj_id ': ' zero_event], zero_event, ...
...
for session_num=1:length(subj_info.sessions)
    [session_erps trial_times session_text]=session_erp(subj_info, ...
        session_num, zero_event, woi, erp_type, 'data_dir', params.data_dir,...
...
img_path=fullfile('analysis',subj_info.subj_id,'erp',[zero_event '_all.png']);
...
img_path=fullfile('analysis',subj_info.subj_id,'erp',[zero_event '_coherence.png']);
...
img_path=fullfile('analysis',subj_info.subj_id,'erp',[zero_event '_congruence.png']);
...
img_path=fullfile('analysis',subj_info.subj_id,'erp',[zero_event '_congruence_coherence.png']);
